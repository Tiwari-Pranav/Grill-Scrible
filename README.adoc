...
TIP: git clone https://github.com/your-username/the-grill-scrible.git

- Install the project dependencies:

TIP: pip install -r requirements.txt

- Fill in necessary database details in settings.py

- Set up database

TIP: python manage.py makemigrations

TIP: python manage.py migrate
